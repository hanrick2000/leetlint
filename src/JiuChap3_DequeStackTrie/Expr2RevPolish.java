 ...
 * Created this class in JiuChap3_DequeStackTrie at 2:40 PM, 11/7/2015.
 */
public class Expr2RevPolish {
  public static void main(String[] args) {
    Expr2RevPolish etp = new Expr2RevPolish();
    String[] exp = new String[]{"(", "5", "-", "6", ")", "*", "7"}; // {"2", "*", "6", "-", "(", "23", "+", "7", ")", "/", "(", "1", "+", "2", ")"};
    ArrayList<String> ans = etp.convertToRPN(exp);
