...
/**
 * Given a list of numbers with duplicate number in it. Find all unique permutations. Learned a big
 * lesson: 1. list of Integer and list of int are different, because == treated different 2. Don't
 * use indexOf 3. fully understand the trace of DFS recursion 4. pre is similar to the substr in
 * palidrome partition
 *
 * @author tzhang
 */
public class PermutationII {
   ...
   */
  private void helperIdxOfWrong(List<List<Integer>> result, List<Integer> list, List<Integer> nums,
      int[] used) {
