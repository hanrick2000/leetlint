 ...
 * Created this class in JiuChap4_TwoPointers at 9:33 AM, 11/10/2015.
 */
public class LengthLongSubstringKdistinct {
  public static void main(String[] args) {
    String s = "eqgkcwGFvjjmxutystqdfhuMblWbylgjxsxgnoh"; // "eceba";
    int k = 16; // 3;
    LengthLongSubstringKdistinct lsk = new LengthLongSubstringKdistinct();
    int ans = lsk.lengthOfLongestSubstringKDistinct(s, k);
    System.out.println(ans);
  }

  /**
   * http://blog.csdn.net/whuwangyi/article/details/42451289
   * Same idea as Rui Bi's minimum size substring contains target string.
   */
