...
/**
 * 只要是String题目, 都要熟练regX或者string的操作.
 * 例如Restore IP 里面用到很多substring.
...
//    listoflist.get(0).addAll(temp);   // 这样是不对的.
     ...
     * http://stackoverflow.com/questions/13055895/java-null-pointer-exception-with-array-of-arraylist
     */
